# Contributing to eslint-plugin-no-em-dash
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/eslint-plugin-no-em-dash.git
cd eslint-plugin-no-em-dash
...
eslint-plugin-no-em-dash/
  lib/
    rules/
      no-em-dash.js       # Rule implementation
    index.js              # Plugin entry point
  tests/
    no-em-dash.test.js    # Unit tests
  docs/
    rules/
      no-em-dash.md       # Rule documentation
```
...
ruleTester.run("no-em-dash", rule, {
  ...
  invalid: [
    {
      code: 'const msg = "Hello - world";',  // em dash
